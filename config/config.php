 ...
 */
$servicios= array(
    "Servidores Virtualbox" => array("VboxClientHandler",$vbox_vms),
    "Servidores VMWare" => array("VMWareClientHandler",$vmware_vms),
    "PC's del laboratorio" => array ("DesktopClientHandler",$desktop_pcs),
    "Equipos adicionales" => array("DesktopClientHandler",$extra_pcs),
    "Servidores Laboratorio" => array("ServerClientHandler",$servers),
);