...
<div id="sock_menu" style="width:200px;">
    ...
    <div class="menu-sep"></div>
    <div data-options="iconCls:'icon-on'" onclick="fireActionFromMap('start')">Power On</div>
    <div data-options="iconCls:'icon-reload'" onclick="fireActionFromMap('restart')">Restart</div>
    <div data-options="iconCls:'icon-off'" onclick="fireActionFromMap('stop')">Power Off</div>
</div>
